...
public class Library
{
    ...
    /**
     * takes in a k value and returns the tchebysheff value
     * @param k K value
     * @return returns tchebysheff as a double
     */
    public double tchebysheff(double k){
        double kSquared = Math.pow(k, 2);
        double shebyshev = 1 - (1/kSquared);
        return shebyshev;
    }
    ...
    public void runTest(){
        ...
        System.out.println("The Chebyshev value is " + tchebysheff(2.085));
